...
<div class="row">
  ...
  <div class="col-md-10 col-md-offset-2">
      ...
      <p> Created: {{$topical->created_at->diffForHumans()}}</p>
      <p>
          <span class="fa fa-clock-o"></span> {{ Carbon\Carbon::parse($topical->created_at)->format('d-m-Y') }}
      </p>
            <hr>
            <div class="embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" src="{{$topical->document}}" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
            </div>
