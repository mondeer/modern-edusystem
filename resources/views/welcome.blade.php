  ...
  <main>
          ...
          <div class="col px-0">
            <div class="row justify-content-center align-items-center">
              <div class="col-lg-7 text-center pt-lg">
                ...
                <p class="lead text-white mt-4 mb-5">Edusystem, The Modern portal for the scholarly enthusiasts,
                                                    Browse your content and enjoy the vast materials uploaded just for you</p>
                <div class="btn-wrapper">
                  <a href="#section-components" class="btn btn-info btn-icon mb-3 mb-sm-0" data-toggle="scroll">
                    <span class="btn-inner--icon"><i class="fa fa-code"></i></span>
                    <span class="btn-inner--text">Get Access</span>
                  </a>
                  <a href="/wiki" class="btn btn-white btn-icon mb-3 mb-sm-0">
    ...
    <section class="section  section-components pb-0" id="section-components">
      <div >
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left">
              <h1 class="imond">Master Your Classes <sup>TM</sup></h1>
            </div>

          </div>
          <div class="row row-grid justify-content-between align-items-center">
            <div class="col-lg-6">
              <h3 class="display-3 text-black">A Mastery Platform for Education
                <span class="text-black">completed with examples and past papers</span>
              </h3>
              <p class="lead text-black">Access educational materials contributed by thousands of community members
                from different and numerous study fields ranging from high school, to college; undergraduate to
                graduate; to many proffesional courses.</p>
              <div class="btn-wrapper">
                  ...
                  <div class="card-header bg-white pb-5">
                    ...
                    <div class="btn-wrapper text-center">
                      <a href="#" class="btn btn-neutral btn-icon">
                        <span class="btn-inner--icon">
                          <img src="./assets/img/icons/common/facebook1.svg">
                        </span>
        ...
        <img src="/assets/img/bg.svg" class="edubg">
      </div>
    </section>
      ...
      <div class="container py-0 pb-lg">
        <div class="row justify-content-between align-items-center">
          <div class="col-lg-5 mb-5 mb-lg-0">
            <h1 class="text-white font-weight-dark">Modern Education Portal</h1>
            <p class="lead text-white mt-4">Modern Edusystem has been collecting data for a while and hosting it while mainting it via google docs.</p>
            <a href="/edusystem/components" class="btn btn-white mt-4">See all components</a>
          </div>
      ...
      <div class="container">
        ...
        <div class="blur--hover">
          <a href="/login">
            ...
            <span class="blur-hidden h5 text-success">Eplore all the Educational content</span>
          </a>
        </div>
      </div>
    </section>
